  ...
  return (
    <div className="group glass-panel glass-panel-hover rounded-3xl overflow-hidden flex flex-col relative border-neutral-800 transition-all duration-300">
      ...
      <div 
        ...
        className="relative bg-linear-to-b from-[#181d29]/90 to-[#0e111a] p-4 sm:p-6 flex items-center justify-center h-48 sm:h-64 md:h-72 cursor-pointer overflow-hidden"
      >
        <img
          src={product.image}
        ...
        <div className="pt-3 border-t border-neutral-800/80 flex items-center justify-between gap-2">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              className="p-2.5 sm:px-3.5 sm:py-2 rounded-xl bg-amber-500/20 hover:bg-amber-500 text-amber-300 hover:text-black font-bold text-xs transition-all duration-200 flex items-center gap-1.5 shadow-sm active:scale-95 min-h-10"
