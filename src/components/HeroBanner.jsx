        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-start z-10">
            ...
            <div className="flex flex-wrap items-center gap-4 pt-2">
              <button
                onClick={onExplore}
                className="btn-gold px-8 py-4 rounded-xl flex items-center gap-3 text-sm sm:text-base font-bold shadow-xl shadow-amber-500/20"
              >
              ...
              <button
                ...
                className="btn-outline-gold px-6 py-4 rounded-xl text-sm sm:text-base font-semibold"
              >
                {t.hero.discoverBtn}
              </button>
            </div>
            ...
            {/* Luxury Trust Stats */}
            <div className="grid grid-cols-3 gap-4 pt-8 border-t border-neutral-800/80">
              ...
              <div className="space-y-1 border-x border-neutral-800 px-3 sm:px-4">
                <div className="text-xl sm:text-2xl lg:text-3xl font-black text-amber-400 font-serif-luxury">
                  {t.hero.stat2Number}
                </div>
                <div className="text-xs text-neutral-400 leading-tight">
